...
def _seed_upcoming_elections():
    ...
    upcoming = [
        ...
        },
        {
            ...
            "slug": "2027-presidential-nass",
            "date": date(2027, 1, 16),
            "status": "upcoming",
            "description": "Presidential, Senate, and House of Representatives elections across 36 states + FCT.",
            "types": [
        ...
        {
            "name": "2027 Governorship & State Assembly Elections",
            "slug": "2027-governorship-state-assembly",
            "date": date(2027, 2, 6),
            "status": "upcoming",
            "description": "Governorship and State Houses of Assembly elections across 36 states + FCT.",
            "types": [
